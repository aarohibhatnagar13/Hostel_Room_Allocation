      ...
      <div className="max-w-md w-full bg-white p-10 rounded-[2.5rem] shadow-xl border border-gray-100 text-center">
        ...
        {status === 'idle' && (
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm font-bold text-gray-500 mb-8">Click the button below to securely verify your Hostel Allocation account.</p>
            <button onClick={handleVerifyClick} className="w-full bg-indigo-600 text-white py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-100 active:scale-95">
              Verify My Account
            </button>
          </div>
        )}
        ...
        {status === 'loading' && (
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-xl font-black text-gray-900 uppercase tracking-tighter">Verifying Credentials...</h2>
          </div>
        )}
        ...
        {status === 'success' && (
          <div className="flex flex-col items-center">
            ...
            <button onClick={() => navigate('/')} className="w-full bg-indigo-600 text-white py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-xl active:scale-95">
              Proceed to Login
            </button>
          </div>
        )}
